                                    ...
                                    <Dropdown>
                                        <DropdownTrigger>
                                            <Button
                                                ...
                                                size='sm'
                                            >
                                                <Avatar size='sm' className='w-full h-full bg-gradient-to-br from-rose-400 to-red-400' name={userData?.firstname?.charAt(0)?.toUpperCase()} src={userData?.avatar} />
                                            </Button>
                                        </DropdownTrigger>
                                        <DropdownMenu aria-label="Static Actions">
                                            {userData?.isOwner ? (
                                                <DropdownItem key="edit" onPress={profileModalOnOpen} className="text-white hover:bg-rose-500/20">{i18next.t('header.edit_profile')}</DropdownItem>
                                            ) : null}
