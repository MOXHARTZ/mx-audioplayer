        ...
        <div className="flex gap-6 md:gap-4 items-center justify-center w-full mb-3">
            <div className="flex w-full items-center justify-center gap-1">
                <Button
                    ...
                    radius="full"
                    variant={repeat ? 'solid' : 'light'}
                    onPress={() => dispatch(setRepeat(!repeat))}
                >
                    <IoRepeat
                        size={24}
                        className={classNames({
                            'text-foreground/80 transition-all duration-500 ease-in-out': true,
                            'text-blue-500 scale-110 rotate-180': repeat,
                            'text-white': !repeat
                        })}
                    />
                </Button>
                ...
                >
                    <IoShuffle
                        ...
                        className={classNames({
                            'text-foreground/80 transition-all duration-500 ease-in-out': true,
                            'text-blue-500 scale-110 rotate-180': shuffle,
                            'text-white': !shuffle
                        })}
                    />
                </Button>
